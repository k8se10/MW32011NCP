...
5. **New reusable Ghidra headless RE scripts** added for future sessions (multi-address caller/reference batch lookups, raw stack-trace/table dumping, signature-byte extraction).
