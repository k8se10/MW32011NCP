...
`FUN_00693b90` (real per-frame render-scene entry, reentrancy-gated via `DAT_025d6e14`) -> `FUN_0052e290` -> `FUN_0050fb80` (trivial one-line forwarder) -> **`FUN_006942e0`** -- this is x86's real, genuine once-per-frame main-scene-pass orchestrator, the direct structural counterpart to x64's `FUN_14018e720`.
