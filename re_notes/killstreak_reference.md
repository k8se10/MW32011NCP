...
| Mortar | Goalpost *(corrected 2026-07-19 — a dedicated zone-identification pass found this is actually Goalpost/`hamburg.ff`; previously misfiled under "Back on the Grid"/`dubai.ff`, which is untested — see `compatibility_matrix.md`)* | ✅ Resolved *(corrected 2026-08-01 — was previously listed as "aim works, fire doesn't"; `known_issues.md` issue #27's own per-bug summary (Bug #5) has since marked this Resolved, decisively — both the mission mis-ID and the regen-buff hypothesis were run down)* | Campaign-unique. |
| Mounted Browning M2 (vehicle turret) | Goalpost *(corrected 2026-07-19 — same mission mis-attribution as Mortar above)* | ✅ Resolved *(corrected 2026-08-01 — was previously listed as "unconfirmed cause"; `known_issues.md` issue #27's own per-bug summary (Bug #6) has since diagnosed this as a missing aim-precision channel, same root cause as DPV, with the scripted-regen-buff hypothesis refuted)* | Campaign-unique. |
