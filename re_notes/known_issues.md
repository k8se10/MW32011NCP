...
Rebuilt `proxy_d3d9.dll` and `ui_hot.dll` -- both compile clean, 0 warnings/0 errors. **Not yet live-tested** -- needs confirmation at 640x480 and 800x600 (both confirmed repros) before this is called closed. The Options screen's own scaling (same underlying class of bug, unconfirmed live) remains open, tracked separately if/when reported.
