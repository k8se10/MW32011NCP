...
resolved. Last updated 2026-08-01 *(corrected again — this line had drifted to
...
## 62. Auto-mantle while sprinting — implemented, STRICTLY opt-in, pending live playtest (2026-08-03)

**Status:** Implemented, not yet live-tested. Built and deployed; needs a real playtest against an actual mantleable ledge before being considered confirmed.
...
**Still needed**: a real live playtest against an actual mantleable ledge in Campaign/Survival to confirm the cone/magnitude thresholds feel right, the real-hint gate actually prevents flat-ground jump-spam, and the cooldown feels natural rather than sluggish.

---

## 63. Vibration strength/reload-vibration follow-up (2026-08-03) — strength fixed live, per-animation-step reload rumble deferred to final scope

**Status:** Strength/duration fix implemented, not yet live-retested. Multi-pulse reload rumble explicitly deferred (roadmap item), not started.
