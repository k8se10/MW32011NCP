...
**Status:** Investigating/in progress. **2026-08-06 major expansion**: all 7 real vanilla tabs (Look/Video/Audio/Voice/AdvancedVideo/Movement/Actions) are now live alongside Controller, plus a new "CUSTOM BINDS" tab -- see the newest round below for the full rundown. Real, tracked work still open:
